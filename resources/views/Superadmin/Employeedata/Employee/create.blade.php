                    ...
                    <form action="{{ route('Employees.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="place_birth" id="place_birth" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="serious_illness" id="serious_illness" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="hereditary_disease">Hereditary Disease</label>
                                <input type="text" name="hereditary_disease" id="hereditary_disease" class="form-control">
                            </div>
